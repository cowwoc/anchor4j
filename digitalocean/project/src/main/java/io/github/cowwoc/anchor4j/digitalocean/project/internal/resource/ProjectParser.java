package io.github.cowwoc.anchor4j.digitalocean.project.internal.resource;
...
import io.github.cowwoc.anchor4j.digitalocean.project.resource.Project.Environment;
...
public final class ProjectParser extends AbstractParser
{
	 ...
	 * @return the project
	 * @throws NullPointerException     if any of the arguments are nul
	 * @throws IllegalArgumentException if no match is found
	 */
	public Project projectFromServer(DefaultProjectClient client, JsonNode json)
	{
		...
		return new DefaultProject(client, id, ownerUuid, ownerId, name, description, purpose, environment,
