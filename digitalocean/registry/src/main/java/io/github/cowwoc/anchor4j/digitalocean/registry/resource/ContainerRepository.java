...
public interface ContainerRepository
{
	 ...
	 */
	Set<ContainerImage> getImages() throws IOException, InterruptedException;
	 ...
	 */
	ContainerImage getImageByPredicate(Predicate<ContainerImage> predicate)
	 ...
	 */
	void destroyImage(ContainerImage.Id imageId)
	 ...
	 *                               due to shutdown signals.
	 */
	void deleteDanglingImages() throws IOException, InterruptedException, AccessDeniedException;
