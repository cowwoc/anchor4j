...
import io.github.cowwoc.anchor4j.core.id.IntegerId;
...
import io.github.cowwoc.anchor4j.digitalocean.registry.resource.ContainerImage.Layer;
...
public final class DefaultContainerRepository implements ContainerRepository
{
	 ...
	 */
	public DefaultContainerRepository(DefaultRegistryClient client, ContainerRegistry registry, String name)
	{
		assert client != null;
	...
	@Override
	public Set<ContainerImage> getImages() throws IOException, InterruptedException
	{
		...
		{
			Set<ContainerImage> images = new HashSet<>();
	...
	@Override
	public ContainerImage getImageByPredicate(Predicate<ContainerImage> predicate)
	...
	@Override
	public void destroyImage(ContainerImage.Id imageId)
		throws IOException, InterruptedException, AccessDeniedException
	{
		...
		ContainerRegistry registry = getRegistry();
	...
	@Override
	public void deleteDanglingImages() throws IOException, InterruptedException, AccessDeniedException
	{
		Set<ContainerImage> imagesToDelete = getImages();
	...
	{
		return o instanceof ContainerRepository other && other.getRegistry().equals(registry) &&
	...
	{
		return new ToStringBuilder(DefaultContainerRepository.class).
