...
public final class DefaultServiceCreator implements ServiceCreator
{
	...
	private final ContainerImage.Id imageId;
	private String name = "";
	 ...
	 * @param imageId the image ID or {@link ContainerImage reference} to create containers from
	 * @throws NullPointerException if {@code imageId} is null
	 */
	public DefaultServiceCreator(InternalDockerClient client, ContainerImage.Id imageId)
	{
		assert client != null;
