...
/**
 * The default implementation of {@code ContainerLogs}.
 */
public final class DefaultContainerLogs implements ContainerLogs
{
	 ...
	 */
	public DefaultContainerLogs(InternalDocker client, String id)
	{
		assert client != null;
	...
	public LogStreams stream() throws IOException
	{
		...
		return new DefaultLogStreams(process);
	}
	 ...
	 */
	public static final class DefaultLogStreams implements LogStreams
	{
		 ...
		 */
		private DefaultLogStreams(Process process)
		{
			assert process != null;
