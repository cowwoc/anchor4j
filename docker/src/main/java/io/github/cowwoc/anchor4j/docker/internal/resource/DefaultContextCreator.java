...
public final class DefaultContextCreator implements ContextCreator
{
	 ...
	 */
	public DefaultContextCreator(InternalDocker client, String name, ContextEndpoint endpoint)
	{
		assert client != null;
	...
	@Override
	public Context create() throws IOException, InterruptedException
	{
