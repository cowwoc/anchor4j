...
/**
 * The default implementation of {@code ContainerCreator}.
 */
public final class DefaultContainerCreator implements ContainerCreator
{
	 ...
	 *                                  </ul>
	 */
	public DefaultContainerCreator(InternalDocker client, String imageId)
	{
		assert client != null;
	...
	@Override
	public Container create() throws IOException, InterruptedException
	{
		...
		return client.container(client.getContainerParser().create(result));
	}
